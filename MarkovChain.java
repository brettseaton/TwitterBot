...
public class MarkovChain implements Iterator<String> {
    ...
    void addBigram(String first, String second) {
        ...
        if (first == null || second == null) {
            throw new IllegalArgumentException("No first word");
        }
    ...
    public void train(Iterator<String> sentence) {
        ...
        startWords.record(nextSentence);

        while (sentence.hasNext()) {
            following = sentence.next();
            addBigram(nextSentence, following);
            nextSentence = following;
        }

        addBigram(nextSentence, END_TOKEN);
    ...
    public boolean hasNext() {
        return (thisWord != null && thisWord != END_TOKEN);
    }
    ...
    public String next() {
        ...
        String storage = thisWord;
        thisWord = null;

        if (chain.containsKey(storage)) {
            thisWord = chain.get(storage).pick(ng);
        }
